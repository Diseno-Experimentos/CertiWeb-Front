...
describe("Backend Integration Tests", () => {
  ...
  describe("Backend Availability", () => {
    ...
    it(
      "should be able to reach the backend",
      async () => {
  ...
  describe("Authentication Endpoints", () => {
    ...
    it(
      "should validate email format on registration",
      async () => {
        if (!backendIsAvailable) {
          console.warn("⚠️  Skipping: Backend is not available");
          return;
  ...
  describe("Public Endpoints", () => {
    it(
      "should be able to fetch data from public endpoints",
      async () => {
        if (!backendIsAvailable) {
          console.warn("⚠️  Skipping: Backend is not available");
          return;
  ...
  describe("CORS Configuration", () => {
    it(
      "should allow requests from the frontend",
      async () => {
        if (!backendIsAvailable) {
          console.warn("⚠️  Skipping: Backend is not available");
          return;
        ...
        try {
          ...
          if (error.code === "ERR_NETWORK") {
            console.warn(
              "⚠️  Network error - this is expected in Node.js environment"
            );
            console.warn(
              "CORS will be tested properly when running in browser"
            );
          } else {
            throw error;
          }
